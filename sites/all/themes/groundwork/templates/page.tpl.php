 ...
 * @see groundwork_preprocess_page()
 */
?>
...
<div id="page">
  ...
  <div id="primary-menu-elements" class="clearfix">
    <div id="container-primary-menu">
    
      <div id="primary" class="nav rounded-corners">
        <div id="primary-inner" class="rounded-corners">
          <h2 class="element-invisible"><?php print t('Main Menu'); ?></h2>
          <?php print $primary_menu; ?>
        </div>
      </div> <!-- /primary link menu -->
    
    </div> <!-- /container-primary-menu -->
  </div> <!-- /primary-menu-elements -->
  <?php endif; ?>
  ...
  <div id="header-elements" class="clearfix">
    ...
    <div id="header" class="clearfix">
          ...
          <?php if ($linked_site_logo or $linked_site_name): ?>
            <?php if ($title): ?>
              <div class="logo-site-name"><strong>
                ...
                <?php if ($site_slogan): ?><span id="site-slogan"><?php print $site_slogan; ?></span> <!-- /slogan --><?php endif; ?>
            ...
            <?php else: /* Use h1 when the content title is empty */ ?>
              ...
              <?php if ($site_slogan): ?><div id="site-slogan"><?php print $site_slogan; ?></div> <!-- /slogan --><?php endif; ?>
            <?php endif; ?>
      ...
      <?php if ($highlight): ?>
        <div id="highlight"><?php print $highlight; ?></div> <!-- /highlight -->
      <?php endif; ?>
  ...
  <div id="main-elements" class="clearfix">
  <?php if ($leaderboard): ?>
  <div id="leaderboard-elements" class="clearfix">
    <div id="container-leaderboard">
    
      <div id="leaderboard"><?php print $leaderboard; ?></div> <!-- /leaderboard -->
        
    </div> <!-- /container-leaderboard -->
  </div> <!-- /leaderboard-elements -->
  <?php endif; ?>
  

  
  <?php if (!empty($menu_bar)): ?>
  <div id="menu-bar-elements" class="clearfix">
    ...
    </div> <!-- /container-menu-bar -->
  </div> <!-- /menu-bar-elements -->
  <?php endif; ?>
  
  <?php if ($messages or $help): ?>
  <div id="messages-help-elements" class="clearfix">
    <div id="container-messages-help">    
    ...
    </div> <!-- /container-messages-help -->
  </div> <!-- /messages-help-elements -->
  <?php endif; ?>
  
  
  <?php if ($secondary_content): ?>
  <div id="secondary-content-elements" class="clearfix">
    <div id="container-secondary-content" class="clearfix">
    
      <div id="secondary-content"><?php print $secondary_content; ?></div> <!-- /secondary-content -->
        
    </div> <!-- /container-secondary-content -->
  </div> <!-- /secondary-content-elements -->
  <?php endif; ?>
  ...
  <div id="container-elements" class="clearfix">
    ...
    <div id="columns"><div class="columns-inner clearfix">
      ...
      <div id="content-column"><div class="content-inner">
        ...
        <?php if ($breadcrumb): ?>
          <div id="breadcrumb">
            <span><?php print t('You are here:'); ?></span> 
  ...
  <div id="tertiary-content-elements" class="clearfix">
    <div id="container-tertiary-content" class="clearfix">
    
      <div id="tertiary-content"><?php print $tertiary_content; ?></div> <!-- /tertiary-content -->
        
    </div> <!-- /container-tertiary-content -->
  </div> <!-- /tertiary-content-elements -->
  <?php endif; ?>
  
  
  <?php if (!empty($secondary_menu)): ?>
  <div id="secondary-menu-elements" class="clearfix">
    ...
    </div> <!-- /container-secondary-menu -->
  </div> <!-- /secondary-menu-elements -->
  <?php endif; ?>
  ...
  <?php if ($footer or $footer_message or $attribution or $feed_icons): ?>
  <div id="footer-elements" class="clearfix">
