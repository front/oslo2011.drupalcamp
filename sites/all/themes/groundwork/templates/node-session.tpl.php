 ...
 * @see groundwork_preprocess_node()
 */
?>
<div<?php print $node_id ? ' id="'. $node_id .'"' : ''; ?> class="<?php print $classes; ?>">
  ...
  <p><?php print flag_create_link('pamelding', $node->nid); ?></p>
  ...
  <?php if ($node_aside && !$teaser): ?>
    <div id="node-aside" class="aside"><?php print $node_aside; ?></div>
  <?php endif; ?>
